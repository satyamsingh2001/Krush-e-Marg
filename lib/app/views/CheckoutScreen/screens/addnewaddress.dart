...
import 'AddMoreDetailsPage.dart';

class AddNewAddresMap extends StatefulWidget {
  const AddNewAddresMap({Key? key}) : super(key: key);
  @override
  _AddNewAddresMapState createState() => _AddNewAddresMapState();
}
class _AddNewAddresMapState extends State<AddNewAddresMap> {
  var lat="0.000";
  var long="0.000";
  var latt;
  var longg;
                        ...
                        showModalBottomSheet(
                          backgroundColor: Colors.transparent,
                            ...
                            builder: (BuildContext context) {
                              return AddMoreDetailsPage(mapAddress: _draggedAddress, sendlat: latt.toString(), sendlong: longg.toString(),);
                            });
                      },
                      child: Center(
                        child: Row(
